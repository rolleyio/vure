...
//         expect(spy).toBeCalledWith(['Lesha', 'Sasha', 'Tati']);
//         done();
//       },
//     );
//   });
...
//         (docs) => {
//           spy(docs.map(({ data: { name } }) => name).sort());
//           expect(spy).toBeCalledWith(['Bagels Tower', 'Pizza City']);
//           resolve(true);
//         },
//       );
//     });
...
//         (docs) => {
//           spy(docs.map(({ data: { name } }) => name).sort());
//           expect(spy).toBeCalledWith(['Kimchi', 'Persik']);
//           resolve(true);
//         },
//       );
//     });
...
//           expect(spy).toBeCalledWith(['Lesha', 'Sasha']);
//           done();
//         },
//       );
//     });
...
//           expect(spy).toBeCalledWith(['+1', 'lul']);
//           done();
//         },
//       );
//     });
...
//           expect(spy).toBeCalledWith(['Sasha', 'Tati', 'Lesha']);
//           done();
//         },
//       );
//     });
...
//         (docs) => {
//           spy(docs.map(({ data: { name } }) => name));
//           expect(spy).toBeCalledWith(['Lesha', 'Tati', 'Sasha']);
//           done();
//         },
//       );
//     });
...
//         (docs) => {
//           spy(docs.map(({ data: { name } }) => name));
//           expect(spy).toBeCalledWith(['Sasha', 'Tati']);
//           done();
//         },
//       );
//     });
...
//         const spyPage1 = jest.fn();
//         const spyPage2 = jest.fn();
//         page1Off = onQuery(
//           contacts,
//           [
//             where('ownerId', '==', ownerId),
...
//             expect(spyPage1).toBeCalledWith(['Sasha', 'Tati']);
//             page1Off();
...
//                 expect(spyPage2).toBeCalledWith(['Lesha']);
//                 done();
//               },
//             );
//           },
...
//           (docs) => {
//             spy(docs.map(({ data: { name } }) => name));
//             expect(spy).toBeCalledWith(['Tati', 'Lesha']);
//             done();
//           },
//         );
//       });
...
//         (docs) => {
//           spy(docs.map(({ data: { name } }) => name));
//           expect(spy).toBeCalledWith(['Tati']);
//           done();
//         },
//       );
//     });
...
//           expect(spy).toBeCalledWith(['published-0', 'published-1']);
//           done();
//         },
//       );
//     });
...
//     //             expect(spy).toBeCalledWith(['Tati', 'Theodor']);

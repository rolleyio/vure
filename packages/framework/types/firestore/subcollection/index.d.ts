...
export declare type NestedSubcollection<Model, ParentModel, ParentIds extends Array<string>> = (
...
export declare function subcollection<Model, SubcollectionModel, SubcollectionParentModel>(
  name: string,

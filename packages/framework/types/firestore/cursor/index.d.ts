...
export interface Cursor<Model, Key extends keyof Model> {
    method: CursorMethod;
    value?: Model[Key] | Doc<Model> | typeofDocId;
}
/**
 ...
 */
export declare function startAfter<Model, Key extends keyof Model>(value?: Model[Key] | Doc<Model> | typeofDocId): Cursor<Model, Key>;
/**
 ...
 * @returns The cursor object
 */
export declare function startAt<Model, Key extends keyof Model>(value?: Model[Key] | Doc<Model> | typeofDocId): Cursor<Model, Key>;
/**
 ...
 * @returns The cursor object
 */
export declare function endBefore<Model, Key extends keyof Model>(value?: Model[Key] | Doc<Model> | typeofDocId): Cursor<Model, Key>;
/**
 ...
 * @returns The cursor object
 */
export declare function endAt<Model, Key extends keyof Model>(value?: Model[Key] | Doc<Model> | typeofDocId): Cursor<Model, Key>;

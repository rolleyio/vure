...
export declare function processQueries<Model>(collection: Collection<Model> | CollectionGroup<Model>, queries: Query<Model, keyof Model>[]): import("firebase/firestore").Query<import("firebase/firestore").DocumentData>;
